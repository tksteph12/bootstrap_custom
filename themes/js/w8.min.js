...
function general_things() {
    ...
    $("#sectorSelector").change(function(event) {
        ...
        var tab = fetchCheckboxOptions(filiere);
        ...
        $('#changingCheckboxes').dropdownCheckbox("append", {
            id: "15",
        ...
        //************Appel ajax***********************
            ...
            $.ajax({
              ...
              success: function(data) {
                tab = fetchcheckOptions(data,filiere);
              }
            });
...
function fetchcheckOptions(data,filiere){
